...
fuse_resnet18(my_model_2)

top1, top5 = evaluate(my_model_2, criterion, data_loader_test, neval_batches=num_eval_batches)
print('Evaluation fused model, accuracy on %d images, %2.2f'%(num_eval_batches * eval_batch_size, top1.avg))
...
per_channel_quantized_model.qconfig = torch.ao.quantization.default_qconfig
...
export_resnet2onnx(per_channel_quantized_model, saved_model_dir + scripted_per_channel_quantized_model_file)



# (base) root@autodl-container-9db611b252-b759e1c0:~/autodl-tmp/workspace/infer_system/pytorch_quantization/eager_mode/ptq_static# python3 resnet.py 
...
# ....................................................................................................Evaluation fused model, accuracy on 5000 images, 87.28
...
# Size (MB): 11.835755
# ....................................................................................................Evaluation accuracy on 5000 images, 87.34
# ============= Diagnostic Run torch.onnx.export version 2.0.0+cu118 =============
# verbose: False, log level: Level.ERROR
# ======================= 0 NONE 0 NOTE 0 WARNING 0 ERROR ========================

# (base) root@autodl-container-9db611b252-b759e1c0:~/autodl-tmp/workspace/infer_system/pytorch_quantization/eager_mode/ptq_static# 